    ...
    <div id="particles-js">
        <div id="main" class="form-signin w-100 m-auto">
            <form action="{{ route('login.store') }}" method="POST" class="º">
                ...
                <div id="grupobotones">
                    <div id="btn-submit"><input type="submit" class="boton" name="enviar" id="btn1"  value="ENTRAR">ENTRAR</div>
                    <div id="btn-registro"><a type="button" class="boton" name="registrar" id="btn2" href="{{ route('register')}}" value="REGISTRAR">REGISTRARSE</a></div>
                </div>
            </form>
            <br>
            <br>
